...
<div class="row" style="padding-top: 20px;">
    ...
    <div class="col-md-3" runat="server" id="divPriceDetails">
             ...
             <div style="border-bottom: 1px solid #eaeaec;">
                <h5 >PRICE DETAILS</h5>
                <div class="proorgpriceview">
                    <label>Cart Total=Rs.<%# Eval("pprice") %></label>
                    <span class="float-right priceGray" id="spanCartTotal" runat="server"></span>
                </div>
                <div class="propricediscountview">
                    <label>Cart Discount=Rs.<%# string.Format("{0}",Convert.ToInt64(Eval("pprice"))-Convert.ToInt64(Eval("psprice"))) %>*OFF</label>
            ...
            <div>
                <div class="proname">
                    <label>Total=Rs.<%# Eval("psprice") %></label>
